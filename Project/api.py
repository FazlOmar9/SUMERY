# testing api without additional parameters


import json
import requests
API_TOKEN = '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'
...
text = """The tower is 324 metres (1,063 ft) tall, about the same height as an 81-storey building,
    ...
    New York City was finished in 1930. It was the first structure to reach a height of 300
    metres. Due to the addition of a broadcasting aerial at the top of the tower in 1957,
